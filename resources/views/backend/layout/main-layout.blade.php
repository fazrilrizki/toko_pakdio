            ...
            <div class="navbar-inner">
                ...
                <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="indexDataJenisProduk">
                                <i class="ni ni-planet text-orange"></i>
                                <span class="nav-link-text">Daftar Jenis Produk</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="indexDataProduk">
                                <i class="ni ni-planet text-orange"></i>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="indexDataPesanan">
                                <i class="ni ni-planet text-orange"></i>
                                <span class="nav-link-text">Daftar Transaksi Pemesanan</span>
                            </a>
                        </li>
                    </ul>
                </div>
