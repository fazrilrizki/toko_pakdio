        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-header border-0">
                    ...
                    <!-- Search form -->
                    <form class="navbar-search navbar-search-light form-inline mr-sm-3" id="navbar-search-main" action="indexDataUsers" method="GET">
                        @csrf
                        <div class="form-group mb-0">
                            <div class="input-group input-group-alternative input-group-merge">
                                ...
                                <input class="form-control" placeholder="Search Data Pelanggan" type="text" name="search">
                            </div>
                        </div>
